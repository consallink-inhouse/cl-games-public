(() => {
    ...
    // ====== Stage select ======
    const STAGE = (() => {
        const n = Number(window.SPEED_ACTION_LEVEL ?? 1);
    ...
    const LEVELS = {
        ...
        // ===== Stage 2: gaps + more enemies + trickier platforms =====
        2: [
            "............................................................................................",
            "............................................................................................",
            "..............................................................................C.............",
        ...
        // ===== Stage 3: more pits + tighter timing + more enemies =====
        3: [
            "............................................................................................",
            ".............................................C......................C.......................",
            "....................C...............B..B..B...............C.................................",
    ...
    function buildLevel() {
        ...
        // safety: map width check (92 fixed想定)
        const width = level[0].length;
        for (let r = 0; r < level.length; r++) {
            const row = level[r];
            if (row.length !== width) {
                console.warn("Level row length mismatch at row:", r, row.length, "expected:", width);
            }
    ...
    // best time (per stage)
    const BEST_KEY = `speed_action_best_time_L${STAGE}`;
    let bestTime = null;
    ...
    function resetGame() {
        ...
        // stage title on overlay
        if (overlay.classList.contains("is-visible")) {
            overlayTitle.textContent = `SPEED ACTION - STAGE ${STAGE}`;
        }
    }
    ...
    function update(dt) {
        ...
        const targetX = clamp(player.x - W * 0.35, 0, worldW - W);
