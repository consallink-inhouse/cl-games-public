...
balloonImg = new Image();
balloonImg.src = "./images/juso/002.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);

balloonImg = new Image();
balloonImg.src = "./images/juso/003.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);

balloonImg = new Image();
balloonImg.src = "./images/juso/004.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);

balloonImg = new Image();
balloonImg.src = "./images/juso/005.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);

balloonImg = new Image();
balloonImg.src = "./images/juso/006.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);

balloonImg = new Image();
balloonImg.src = "./images/juso/007.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);

balloonImg = new Image();
balloonImg.src = "./images/juso/008.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push(balloonImg);
