...
balloonImg.src = "./images/tonichipr/001.png";
...
balloonImg.src = "./images/tonichipr/002.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push({
    img: balloonImg,
    width: 100,
...
balloonImg = new Image();
balloonImg.src = "./images/tonichipr/003.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push({
    img: balloonImg,
    width: 100,
...
balloonImg = new Image();
balloonImg.src = "./images/tonichipr/004.png";
balloonImg.onload = markBalloonLoaded;
balloonImages.push({
    img: balloonImg,
    width: 100,
